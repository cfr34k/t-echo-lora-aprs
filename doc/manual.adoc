...
This document describes how to operate the T-Echo.
...
- `Info >` +
  Open the <<_info,device/firmware information menu>>.
...
This submenu provides information about the firmware and the most relevant device settings.
